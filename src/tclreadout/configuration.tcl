...
v27xxpha config adc1 gbltriggersrc TestPulse \
    ...
    testpulseperiod 100000000 testpulsewidth 16
...
v27xxpha config adc1 recordsamples [lrepeat 64 512]  \
    ...
    analogprobe1 [lrepeat 64 ADCInput]  analogprobe2 [lrepeat 64 TimeFilter] \
...
v27xxpha config adc1 pretriggersamples [lrepeat 64 200]

# Filter and conditioning parameters

v27xxpha config adc1 tfrisetime [lrepeat 64 10] efrisetime [lrepeat 64 100] \
    efflattoptime [lrepeat 64 100] triggerthresholds [lrepeat 64 3] \
